...
public class CameraActionHandler implements OnImageAvailableListener {
  ...
  /**
   * Performs action on {@link GlassGestureDetector.Gesture#SWIPE_UP} TODO: make TWO_FINGER_SWIPE_UP
   * gesture.
   */
  public void performSwipeUpAction() {
    Log.d(TAG, "Performing swipe up action");
  }

  /**
   * Performs action on {@link GlassGestureDetector.Gesture#TWO_FINGER_SWIPE_DOWN}
   * gesture.
   */
  public void performTwoFingerSwipeDownAction() {
    Log.d(TAG, "Performing two finger swipe down action");
  }
