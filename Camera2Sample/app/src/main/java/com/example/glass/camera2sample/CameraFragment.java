  ...
  public boolean onGesture(GlassGestureDetector.Gesture gesture) {
    switch (gesture) {
      ...
      case SWIPE_DOWN:
        ...
        return true;
      case SWIPE_UP:   // ZOOM IN TODO: make TWO_FINGER_SWIPE_UP, currently SWIPE_UP for ease of development
        cameraActionHandler.performSwipeUpAction();
        return true;
      case TWO_FINGER_SWIPE_DOWN: // ZOOM OUT
        cameraActionHandler.performTwoFingerSwipeDownAction();
        return true;
      default:
        return false;
    }
